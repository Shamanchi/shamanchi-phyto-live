// Чистые помощники каталога/корзины Сборки Б. Всё строится на data/products.json
...
// СДЭК бесплатно при сумме заказа после скидок от порога (условия phytotab.ru).
