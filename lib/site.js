// Общие константы Сборки Б — реальный магазин PHYTOTAB (phytotab.ru) на платформе Shamanchi.
// Репозиторий подготовлен как предложение для phytotab.ru (см. README). До решения заказчика
// о запуске сайт не регистрируется на доменах бренда и не показывается как действующий магазин.
...
// Публичные контакты PHYTOTAB (с phytotab.ru, открытые данные)
...
export const PHYTOTAB_SITE = "https://phytotab.ru/";
...
// --- Бренд реального магазина (публичные данные phytotab.ru) ---
export const BRAND = {
  name: "PHYTOTAB",
  wordmarkA: "PHYTO",
  wordmarkB: "TAB",
...
// --- SEO Сборки Б: реальные товарные запросы ниши ---
export const SEO = {
...
export const SHOP = {
  ...
  // Пороги бесплатной доставки СДЭК (условия phytotab.ru, по федеральным округам)
