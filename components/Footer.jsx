    ...
    <footer className="border-t border-line bg-cream/80">
      <div className="wrap py-12">
        <div className="grid gap-10 md:grid-cols-[1.3fr_1fr_1fr_1.2fr]">
          <div>
            <Link href="/" className="flex items-center gap-2.5" aria-label={`${BRAND.wordmarkA} ${BRAND.wordmarkB} — на главную`}>
          ...
          <nav aria-label="Покупателям">
            <p className="font-mono text-[10px] uppercase tracking-[0.16em] text-ink/80">покупателям</p>
          ...
          <nav aria-label="Сервис">
            <p className="font-mono text-[10px] uppercase tracking-[0.16em] text-ink/80">сервис</p>
            <ul className="mt-4 space-y-2.5">
          ...
          <div>
            <p className="font-mono text-[10px] uppercase tracking-[0.16em] text-ink/80">контакты</p>
            <ul className="mt-4 space-y-2.5 text-[15px] font-semibold">
              ...
              <li className="text-[13.5px] font-medium leading-relaxed text-ink/80">
        ...
        <div className="mt-10 space-y-2 border-t border-line pt-6 font-mono text-[11px] leading-relaxed text-ink/85">
          <p>
